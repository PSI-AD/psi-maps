...
const MainLayout: React.FC<MainLayoutProps> = ({
    ...
    return (
        <div className="flex flex-col h-screen w-screen overflow-hidden bg-white font-sans">
            ...
            {isAdminOpen && <AdminDashboard onClose={() => setIsAdminOpen(false)} liveProjects={liveProjects} setLiveProjects={setLiveProjects} />}
            ...
            <div className="flex flex-col md:flex-row flex-1 overflow-hidden mt-20 relative">
                ...
                <div className={`${viewMode === 'map' ? 'flex' : 'hidden md:flex'} flex-1 w-full h-full relative bg-slate-100`}>
                    <div className="absolute top-4 left-1/2 -translate-x-1/2 z-[2000] pointer-events-none"><div className="pointer-events-auto"><AmenityFilterBar activeFilters={activeAmenities} onToggle={onToggleAmenity} isDrawActive={isDrawing} onToggleDraw={onToggleDraw} /></div></div>
                    {children}
